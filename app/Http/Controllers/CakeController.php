...
class CakeController extends Controller
{
    ...
    public function category(){
        return view('cakeadmin.category');
    }
    ...
    public function viewcategory(){
        ...
        return view('cakeadmin.viewcategory',compact('categorytype'));
    }


    public function report(){
        $details=Additinerary::paginate(10);
        return view('cakeadmin.viewitinerary',compact('details'));
    }
...
//      return view('cakeadmin.itinerary',compact('select','complementary'));
    ...
    public function viewitinerary($id){
        ...
        return view('cakeadmin.fulldetail',compact('details'));
    }
    ...
    public function itineraryedit($id){
        ...
        $complementary=Complementaries::all();
        $details=Additinerary::find($id);
        return view('cakeadmin.itineraryedit',compact('details','catagories','complementary'));
    }
    ...
    public function complementary(request $request){
        return view ('cakeadmin.complementary');
    }
    ...
    public function viewcomplementary(request $request){
        $complementary=Complementaries::all();
        return view ('cakeadmin.viewcomplementary',compact('complementary'));
    }



    public function resetPassword(){
        return view('cakeadmin.resetPassword');
    }
